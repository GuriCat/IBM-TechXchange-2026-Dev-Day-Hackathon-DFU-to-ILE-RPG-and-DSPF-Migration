     ...
     DreturnPt         S              6A
       ...
       // ============================================================
       // #CHAIN  Position by RECNBR (RRN) entered on screen
       // ============================================================
       BEGSR #CHAIN;
       CHAIN(E) RECNBR CUSREC;
       EXSR #DBEX;
       IF NOT %FOUND;
         ws.errorMsg_50   = *ON;
         MSGDTA           = ' Record not found.';
       ...
       // ============================================================
       // #RDNXT  Read next record; wrap to RRN=1 on EOF
       // ============================================================
       BEGSR #RDNXT;
       READ(E) CUSREC;
       EXSR #DBEX;
       ...
       ENDIF;
       IF NOT %EOF AND NOT ws.errorMsg_50;
         wkRRN           = dbfRRN;
         ws.dspDetail_60 = *ON;
       ENDIF;
       ENDSR;
